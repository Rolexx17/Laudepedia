...
const HomePage = () => {
  ...
  return (
    <>
      <Navbar />
      {/* Container utama dengan padding-bottom untuk BottomNav */}
      <div className="home-page main-content-wrapper" style={{ paddingBottom: '80px' }}>
...
const Feature = ({ icon, label, onClick }) => (
  <div onClick={onClick} style={{ cursor: 'pointer', minWidth: '60px' }}>
    <div className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-1 shadow-sm icon-circle-wrapper"
...
const Product = ({ img, price, onClick }) => (
  <div className="col" onClick={onClick} style={{ cursor: 'pointer' }}>
    <div className="card h-100 border-0 rounded-4 shadow-sm overflow-hidden product-card-home">
