  ...
  return (
    <div className="product-detail-page">
      ...
      <main className="item-container container mt-4">
        <div className="row">
          {/* Bagian Gambar Produk B7 */}
          <div className="col-md-6 item-image text-center">
            <img 
              src="resources/B7.jpg" 
              alt="Romantic Floral Cropped Top with Lace Trim" 
              className="img-fluid rounded shadow"
              style={{ maxWidth: '100%', height: 'auto' }}
            />
          </div>

          {/* Bagian Informasi Produk B7 */}
          <div className="col-md-6 item-info mt-4 mt-md-0">
            <h2 className="item-title fw-bold">Romantic Floral Cropped Top with Lace Trim</h2>
            <p className="item-price fs-3 fw-bold" style={{ color: '#bfa76a' }}>Rp 500.000</p>
            
            <div className="item-description my-4 text-muted">
              <strong>Feminine charm, vintage touch.</strong><br /><br />
              Ruffled hems and short sleeves add playful movement, while the pink-and-green floral print captures timeless romantic energy.<br /><br />
            ...
            <div className="item-action d-flex align-items-center gap-3 flex-wrap">
              ...
              <button 
                ...
                onClick={() => alert('Item B7 berhasil ditambahkan!')}
              >
                Buy Now
              </button>
            </div>
