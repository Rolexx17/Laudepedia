...
// Import semua file detail yang sudah kita buat
...
function App() {
  // State untuk menyimpan halaman mana yang aktif
  // null berarti di halaman utama
  ...
  const renderPage = () => {
    switch(activePage) {
      ...
      default: return <HomePage onProductClick={(id) => setActivePage(id)} />;
    }
  };
