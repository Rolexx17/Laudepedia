  ...
  return (
    <div className="product-detail-page">
      ...
      <main className="item-container container mt-4">
        <div className="row">
          {/* Bagian Gambar Produk T1 */}
          <div className="col-md-6 item-image text-center">
            <img 
              src="resources/T1.jpg" 
              alt="Black Urban Leather Shoulder Bag" 
              className="img-fluid rounded shadow"
              style={{ maxWidth: '100%', height: 'auto' }}
            />
          </div>

          {/* Bagian Informasi Produk T1 */}
          <div className="col-md-6 item-info mt-4 mt-md-0">
            <h2 className="item-title fw-bold">Black Urban Leather Shoulder Bag</h2>
            <p className="item-price fs-3 fw-bold" style={{ color: '#bfa76a' }}>Rp 125.000</p>
            
            <div className="item-description my-4 text-muted">
              This stylish black messenger bag features a sleek leather exterior with a flap closure and metal accent detailing for a modern urban look.<br /><br />
              Designed with adjustable shoulder straps for comfort, it offers ample space for essentials like books, tablets, or daily accessories.<br /><br />
              Perfect for work, school, or casual outings, this bag combines practicality with a bold, contemporary style.
            </div>

            <div className="item-rating mb-4">
              <span className="text-warning">★★★★★</span> 
              <span className="ms-2">4.9/5 (3.9k reviews)</span>
            </div>
            ...
            <div className="item-action d-flex align-items-center gap-3 flex-wrap">
              ...
              <button 
                ...
                onClick={() => alert('Bag T1 berhasil ditambahkan!')}
              >
                Buy Now
              </button>
            </div>
