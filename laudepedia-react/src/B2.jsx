  ...
  return (
    <div className="product-detail-page">
      ...
      <main className="item-container container mt-4">
        <div className="row">
          {/* Bagian Gambar Produk B2 */}
          <div className="col-md-6 item-image text-center">
            <img 
              src="resources/B2.jpg" 
              alt="Abstract Teal Oversized Knit Sweater" 
              className="img-fluid rounded shadow"
              style={{ maxWidth: '100%', height: 'auto' }}
            />
          </div>

          {/* Bagian Informasi Produk B2 */}
          <div className="col-md-6 item-info mt-4 mt-md-0">
            <h2 className="item-title fw-bold">Abstract Teal Oversized Knit Sweater</h2>
            <p className="item-price fs-3 fw-bold" style={{ color: '#bfa76a' }}>Rp 950.000</p>
            
            <div className="item-description my-4 text-muted">
              <strong>Art meets comfort.</strong><br /><br />
              A statement sweater with a bold teal base and abstract white-blue patterns. 
              Its oversized fit, ribbed neckline, cuffs, and hem combine coziness with artistic flair.<br /><br />
            ...
            <div className="item-action d-flex align-items-center gap-3 flex-wrap">
              ...
              <button 
                ...
                onClick={() => alert('Sweater B2 berhasil ditambahkan!')}
              >
                Buy Now
              </button>
            </div>
