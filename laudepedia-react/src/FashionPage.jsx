...
const FashionPage = ({ onBack, onProductClick }) => {
  ...
  return (
    <div className="fashion-page">
      ...
      <section className="trending py-5 bg-light">
        <div className="container">
          <h2 className="fw-semibold text-gold mb-3">Trending November</h2>
          <div className="scroll-container d-flex flex-nowrap overflow-auto pb-3">
            {trendingProducts.map((product) => (
              <div 
                key={product.id} 
                className="card product-card me-3 flex-shrink-0" 
                style={{ width: '180px', cursor: 'pointer' }}
                onClick={() => onProductClick(product.id)} // Memanggil ID produk (B1, B2, dst)
              >
